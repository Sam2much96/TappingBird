...
#
# To Do:
#(1) Simplify CodeBase To use Dynamic fonts not png files 
# *************************************************
...
func _ready():
	var anim = utils.get_main_node().get_node("hud/game_over/anim") # get animation player
...
func set_number(num):
	for child in get_children(): # bad code, deletes all children sprite
		child.free()
