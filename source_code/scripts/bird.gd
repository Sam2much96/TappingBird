...
#
# To Do:
# (1) Simplify Codebase and Export Variables to Inspector Tab
# (2) Remove Unnecessary Boiler Plate Code
# (3) rewrite State Machine To use Physics Process for State Machine 
# *************************************************
...
# To Do: Use Enumerations Instead
...
var prev_state = STATE_FLAPPING # set default state
...
func get_state(): # Huh? # use match instead?
	# Triggers Game Start
...
"""
FINITE STATE MACHINE AS SEPARATE CLASSES
"""
